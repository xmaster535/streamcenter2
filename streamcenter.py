        ...
        events.append(
            {
                ...
                "logoTeam1": stream_group.get("logoTeam1", ""),
                "logoTeam2": stream_group.get("logoTeam2", ""),
            }
        )
...
async def scrape() -> None:
    ...
    if events := await get_events():
        ...
        for i, ev in enumerate(events, start=1):
            ...
            tvg_id, league_logo = leagues.get_tvg_info(sport, event)
            ...
            entry = {
                ...
                "logo": logo1 if logo1 else (league_logo or ""),
                "logoTeam1": logo1,
                "logoTeam2": logo2,
...
def export_to_list() -> list:
    ...
    for key, data in urls.items():
        ...
        entry = {
            ...
            "teamAFlag": teamA_flag,
            "teamAName": f"[{sport}] {event_name}",
            "teamBFlag": teamB_flag,
            "teamBName": "",
            "time": time_str
        }
        result.append(entry)
